...
#   IQR <- IQR(data[[column]])
# 
#   data[data[[column]] > (Q1 - 1.5 * IQR) & data[[column]] < (Q3 + 1.5 * IQR), ]
# }
# 
# # Usuwanie wartości odstających dla wszystkich kolumn w zbiorze numeric_data
# for (col in names(numeric_data)) {
#   cleared_numeric_data <- remove_outliers(numeric_data, col)
# }
```
...
# cleared_data <- data
```
<!-- TODO: TYM SPOSOBEM USUNĘŁAM PRAWIE POŁOWĘ ZBIORU - TO COŚ NIE TAK, MOŻE LEPIEJ UŻYĆ Z-SCORE; MOŻE NIE ROBIĆ TEGO DLA KOLUMNY STEPS I MAX VOLTAGE STEP -->
